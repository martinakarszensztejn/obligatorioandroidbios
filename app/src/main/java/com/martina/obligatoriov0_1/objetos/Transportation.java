...
public class Transportation {
    ...
    private String vehiculo_chofer;
    ...
    public String getVehiculo_chofer() {
        return vehiculo_chofer;
    }

    public void setVehiculo_chofer(String vehiculo_chofer) {
        this.vehiculo_chofer = vehiculo_chofer;
    }

    public String getRecepcion_nombre_receptor() {
        return recepcion_nombre_receptor;
    }

    public void setRecepcion_nombre_receptor(String recepcion_nombre_receptor) {
        this.recepcion_nombre_receptor = recepcion_nombre_receptor;
    }

    public String getRecepcion_observacion() {
        return recepcion_observacion;
    }

    public void setRecepcion_observacion(String recepcion_observacion) {
        this.recepcion_observacion = recepcion_observacion;
    }
